...
TARGET_KERNEL_CONFIG := vendor/kona-perf_defconfig vendor/debugfs.config vendor/custom.config vendor/xiaomi/sm8250-common.config
...
ifneq ($(TARGET_IS_TABLET),true)
DEVICE_MANIFEST_FILE += $(COMMON_PATH)/vintf/manifest_phone.xml
endif
ifeq ($(TARGET_HAS_UDFPS),true)
DEVICE_MANIFEST_FILE += $(COMMON_PATH)/vintf/manifest_fod.xml
endif
